...
OBJS = tmp/obj/kasm.o tmp/obj/kc.o tmp/obj/idt.o tmp/obj/ata.o tmp/obj/printf.o tmp/obj/isr.o tmp/obj/kb.o tmp/obj/string.o tmp/obj/system.o tmp/obj/util.o tmp/obj/shell.o tmp/obj/disk.o tmp/obj/fat32.o tmp/obj/rtc.o tmp/obj/testing.o tmp/obj/pmm.o tmp/obj/gdtasm.o tmp/obj/gdt.o tmp/obj/timer.o tmp/obj/schedule.o tmp/obj/pci.o tmp/obj/israsm.o tmp/obj/taskasm.o tmp/obj/task.o tmp/obj/liballoc.o tmp/obj/vga.o tmp/obj/console.o tmp/obj/backupconsole.o tmp/obj/serial.o tmp/obj/elf.o tmp/obj/paging.o tmp/obj/vmm.o tmp/obj/syscalls.o
...
tmp/obj/syscalls.o:src/cpu/syscalls.c
	$(COMPILER) $(CFLAGS) src/cpu/syscalls.c -o tmp/obj/syscalls.o 
